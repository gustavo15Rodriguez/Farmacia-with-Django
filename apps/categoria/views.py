...
class ReporteCategoriaPDF(View):
    ...
    def cabecera(self, pdf):
        ...
        pdf.drawString(230, 750, u"REPORTE DE CATEGORIAS")
    ...
    def tabla(self, pdf, y):
        ...
        detalle = [(categoria.cod_categoria, categoria.nom_categoria) for categoria in Categoria.objects.all()]
...
class CategoriaEliminar(DeleteView):
    model = Categoria
    template_name = 'categoria/categoria_eliminar.html'
    success_url = reverse_lazy('listar_categorias')